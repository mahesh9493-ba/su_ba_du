  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-4xl flex flex-col items-center relative z-10 pt-2">
        <h1
          onDoubleClick={() => onBypassPhase && onBypassPhase('reveal')}
          className={`text-3xl md:text-5xl font-serif font-bold tracking-wide mb-1 text-center leading-tight transition-all duration-1000 bg-clip-text text-transparent cursor-default select-none ${themeConfig.titleGlow}`}
